        ...
        <footer className="footer_container">
                ...
                <div className="footer_container_content">
                    ...
                    <div className="footer_horaires">
                        <h3>{t('footer.horaire')}</h3>
                            <p>{t('footer.horaire_coffee_semaine')}</p>
                            <p>{t('footer.horaire_coffee_weekend')}</p> 
                            <br></br>                    
                        <h4>{t('footer.horaire_cuisine')}</h4>
                            <p>{t('footer.horaire_cuisine_semaine')}</p>
                            <p>{t('footer.horaire_cuisine_weekend')}</p>
