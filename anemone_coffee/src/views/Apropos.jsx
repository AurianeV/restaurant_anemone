...
function Apropos({ navbarProps }) {
    ...
    return (
        <div>
            ...
            Chez Anémone Café, le partage est au cœur de notre philosophie. Que ce soit autout d'un café le matin ou lors de nos brunchs du week-end, nous croyons que chaque moment passé ensemble compte. Nous souhaitons créer un lieu où les amis se retrouvent, où les familles se rassemblent et où de nouvelles amitiés peuvent naître.<br/><br/>
